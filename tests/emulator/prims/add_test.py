...
if __name__ == "__main__":
    graph, true_output = construct_add_graph()
    ...
    print(torch.mean(torch.abs(outputs["output"] - true_output)))
    
    
    print("Add operation graph constructed and processed successfully.")