...
def construct_multiply_graph() -> Graph:
    graph = Graph()
    ...
    multiply_op = Multiply("multiply_op", {"output_dtype": DataType.BF16, "bc_mode": 0, "mult_or_div": 0, "scalar": 0})
...
if __name__ == "__main__":
    graph = construct_multiply_graph()
