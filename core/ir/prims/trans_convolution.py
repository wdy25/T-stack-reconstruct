...
class PrimTransConvolution(Primitive):
    def __init__(self,
        conv_type,
        isSNN,
        deps,
        ...
        super().__init__()
        self.name = "TransConvolution"  # 定义名称
        ...
        self.x_in_h = x_in_h
        self.x_in_w = x_in_w
        self.xhjump = input_dilation_h
        self.xwjump = input_dilation_w
        self.c_in = c_in
        self.c_out = c_out
        self.k_h = k_h
        self.k_w = k_w
        ...
        self.param_addr_3 = param_addr_3
        ...
        self.y_out_w = self.x_in_w + (self.x_in_w - 1) * (self.xwjump - 1) + self.padding_left + self.padding_right - self.k_w + 1
        self.y_out_h = self.x_in_h + (self.x_in_h - 1) * (self.xhjump - 1) + self.padding_bottom + self.padding_top - self.k_h + 1
        # self.y_out_h = (self.x_in_h + self.padding_top + self.padding_bottom - (self.k_h + (self.dilation_h - 1) * (self.k_h - 1))) // self.stride_h + 1

        self.x_addr_base = self.x_in_addr - (self.padding_top // self.xhjump * self.x_in_w + self.padding_left // self.xwjump) * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_1 = (1 // self.xwjump + 1) * self.stride_w * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_9 = (1 // self.xwjump) * self.stride_w * self.cin_16 * self.x_dw / 256
        # self.x_addr_gap_2 = -(self.xreg_depth - 1) * self.stride_w * self.cin_16 * self.x_dw / 256 + self.xreg_width * self.x_dw / 256
        self.x_addr_gap_2 = self.xreg_width * self.x_dw / 256
        self.x_addr_gap_3 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + self.dilation_w // self.xwjump * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_10 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + (self.dilation_w // self.xwjump + 1) * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_4 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + (-(self.k_w - 1) * self.dilation_w // self.xwjump) * self.cin_16 * self.x_dw / 256 + (self.dilation_h // self.xhjump) * self.x_in_w * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_11 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + (-(self.k_w - 1) * self.dilation_w // self.xwjump + 1) * self.cin_16 * self.x_dw / 256 + (self.dilation_h // self.xhjump) * self.x_in_w * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_12 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + (-(self.k_w - 1) * self.dilation_w // self.xwjump) * self.cin_16 * self.x_dw / 256 + (self.dilation_h // self.xhjump + 1) * self.x_in_w * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_13 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + (-(self.k_w - 1) * self.dilation_w // self.xwjump + 1) * self.cin_16 * self.x_dw / 256 + (self.dilation_h // self.xhjump + 1) * self.x_in_w * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_5 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + (-(self.k_w - 1) * self.dilation_w // self.xwjump) * self.cin_16 * self.x_dw / 256 + (-(self.k_h - 1) * self.dilation_h // self.xhjump) * self.x_in_w * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_14 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + (-(self.k_w - 1) * self.dilation_w // self.xwjump + 1) * self.cin_16 * self.x_dw / 256 + (-(self.k_h - 1) * self.dilation_h // self.xhjump) * self.x_in_w * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_15 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + (-(self.k_w - 1) * self.dilation_w // self.xwjump) * self.cin_16 * self.x_dw / 256 + (-(self.k_h - 1) * self.dilation_h // self.xhjump + 1) * self.x_in_w * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_16 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + (-(self.k_w - 1) * self.dilation_w // self.xwjump + 1) * self.cin_16 * self.x_dw / 256 + (-(self.k_h - 1) * self.dilation_h // self.xhjump + 1) * self.x_in_w * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_6 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + ((-(self.k_w - 1) * self.dilation_w + 8 * self.stride_w) // self.xwjump) * self.cin_16 * self.x_dw / 256 + (-(self.k_h - 1) * self.dilation_h // self.xhjump) * self.x_in_w * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_17 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + ((-(self.k_w - 1) * self.dilation_w + 8 * self.stride_w) // self.xwjump + 1) * self.cin_16 * self.x_dw / 256 + (-(self.k_h - 1) * self.dilation_h // self.xhjump) * self.x_in_w * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_18 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + ((-(self.k_w - 1) * self.dilation_w + 8 * self.stride_w) // self.xwjump) * self.cin_16 * self.x_dw / 256 + (-(self.k_h - 1) * self.dilation_h // self.xhjump + 1) * self.x_in_w * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_19 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + ((-(self.k_w - 1) * self.dilation_w + 8 * self.stride_w) // self.xwjump + 1) * self.cin_16 * self.x_dw / 256 + (-(self.k_h - 1) * self.dilation_h // self.xhjump + 1) * self.x_in_w * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_7 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + ((-(self.k_w - 1) * self.dilation_w - (self.y_out_w // 8) * 8 * self.stride_w) // self.xwjump) * self.cin_16 * self.x_dw / 256 + ((-(self.k_h - 1) * self.dilation_h + self.stride_h) // self.xhjump) * self.x_in_w * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_20 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + ((-(self.k_w - 1) * self.dilation_w - (self.y_out_w // 8) * 8 * self.stride_w) // self.xwjump + 1) * self.cin_16 * self.x_dw / 256 + ((-(self.k_h - 1) * self.dilation_h + self.stride_h) // self.xhjump) * self.x_in_w * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_21 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + ((-(self.k_w - 1) * self.dilation_w - (self.y_out_w // 8) * 8 * self.stride_w) // self.xwjump) * self.cin_16 * self.x_dw / 256 + ((-(self.k_h - 1) * self.dilation_h + self.stride_h) // self.xhjump + 1) * self.x_in_w * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_22 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + ((-(self.k_w - 1) * self.dilation_w - (self.y_out_w // 8) * 8 * self.stride_w) // self.xwjump + 1) * self.cin_16 * self.x_dw / 256 + ((-(self.k_h - 1) * self.dilation_h + self.stride_h) // self.xhjump + 1) * self.x_in_w * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_8 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + ((-(self.k_w - 1) * self.dilation_w - (self.y_out_w // 8) * 8 * self.stride_w) // self.xwjump) * self.cin_16 * self.x_dw / 256 + ((-(self.k_h - 1) * self.dilation_h - self.y_out_h * self.stride_h) // self.xhjump) * self.x_in_w * self.cin_16 * self.x_dw / 256 + self.x_in_w * self.x_in_h * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_23 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + ((-(self.k_w - 1) * self.dilation_w - (self.y_out_w // 8) * 8 * self.stride_w) // self.xwjump + 1) * self.cin_16 * self.x_dw / 256 + ((-(self.k_h - 1) * self.dilation_h - self.y_out_h * self.stride_h) // self.xhjump) * self.x_in_w * self.cin_16 * self.x_dw / 256 + self.x_in_w * self.x_in_h * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_24 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + ((-(self.k_w - 1) * self.dilation_w - (self.y_out_w // 8) * 8 * self.stride_w) // self.xwjump) * self.cin_16 * self.x_dw / 256 + ((-(self.k_h - 1) * self.dilation_h - self.y_out_h * self.stride_h) // self.xhjump + 1) * self.x_in_w * self.cin_16 * self.x_dw / 256 + self.x_in_w * self.x_in_h * self.cin_16 * self.x_dw / 256
        self.x_addr_gap_25 = -(self.cin_16 / self.xreg_width - 1) * self.xreg_width * self.x_dw / 256 + ((-(self.k_w - 1) * self.dilation_w - (self.y_out_w // 8) * 8 * self.stride_w) // self.xwjump + 1) * self.cin_16 * self.x_dw / 256 + ((-(self.k_h - 1) * self.dilation_h - self.y_out_h * self.stride_h) // self.xhjump + 1) * self.x_in_w * self.cin_16 * self.x_dw / 256 + self.x_in_w * self.x_in_h * self.cin_16 * self.x_dw / 256
        ...
        self.xw_cnt_gap_1_mod = self.xw_cnt_gap_1 % self.xwjump
        self.xw_cnt_gap_2_mod = self.xw_cnt_gap_2 % self.xwjump
        self.xw_cnt_gap_3_mod = self.xw_cnt_gap_3 % self.xwjump
        self.xw_cnt_gap_4_mod = self.xw_cnt_gap_4 % self.xwjump
        self.xh_cnt_gap_1_mod = self.xh_cnt_gap_1 % self.xhjump
        self.xh_cnt_gap_2_mod = self.xh_cnt_gap_2 % self.xhjump
        self.xh_cnt_gap_3_mod = self.xh_cnt_gap_3 % self.xhjump
        self.xh_cnt_gap_4_mod = self.xh_cnt_gap_4 % self.xhjump
        self.xw0_cnt_init = (-self.padding_left-1) % self.xwjump
        self.xw0_init = (-self.padding_left) % self.xwjump
        self.xw_cnt_gap_0_mod = 1 % self.xwjump
        self.xh0_init = (-self.padding_top) % self.xhjump
        ...
        self.param2[204:200] = to_signed_bits(self.xw_cnt_gap_1_mod,4)
        self.param2[208:204] = to_signed_bits(self.xw_cnt_gap_2_mod,4)
        self.param2[212:208] = to_signed_bits(self.xw_cnt_gap_3_mod,4)
        self.param2[216:212] = to_signed_bits(self.xw_cnt_gap_4_mod,4)
        self.param2[220:216] = to_signed_bits(self.xh_cnt_gap_1_mod,4)
        self.param2[224:220] = to_signed_bits(self.xh_cnt_gap_2_mod,4)
        self.param2[228:224] = to_signed_bits(self.xh_cnt_gap_3_mod,4)
        self.param2[232:228] = to_signed_bits(self.xh_cnt_gap_4_mod,4)
        self.param2[236:232] = to_signed_bits(self.xw0_init,4)
        self.param2[240:236] = to_signed_bits(self.xh0_init,4)
        self.param2[244:240] = to_signed_bits(self.xw0_cnt_init,4)
        self.param2[248:244] = to_signed_bits(self.xw_cnt_gap_0_mod,4)
        self.param3 = intbv(0)[256:]
        self.param3[16:0] = to_signed_bits(int(self.x_addr_gap_10),16)
        self.param3[32:16] = to_signed_bits(int(self.x_addr_gap_11),16)
        self.param3[48:32] = to_signed_bits(int(self.x_addr_gap_12),16)
        self.param3[64:48] = to_signed_bits(int(self.x_addr_gap_13),16)
        self.param3[80:64] = to_signed_bits(int(self.x_addr_gap_14),16)
        self.param3[96:80] = to_signed_bits(int(self.x_addr_gap_15),16)
        self.param3[112:96] = to_signed_bits(int(self.x_addr_gap_16),16)
        self.param3[128:112] = to_signed_bits(int(self.x_addr_gap_17),16)
        self.param3[144:128] = to_signed_bits(int(self.x_addr_gap_18),16)
        self.param3[160:144] = to_signed_bits(int(self.x_addr_gap_19),16)
        self.param3[176:160] = to_signed_bits(int(self.x_addr_gap_20),16)
        self.param3[192:176] = to_signed_bits(int(self.x_addr_gap_21),16)
        self.param3[208:192] = to_signed_bits(int(self.x_addr_gap_22),16)
        self.param3[224:208] = to_signed_bits(int(self.x_addr_gap_23),16)
        self.param3[240:224] = to_signed_bits(int(self.x_addr_gap_24),16)
        self.param3[256:240] = to_signed_bits(int(self.x_addr_gap_25),16)
        ...
        self.data_blocks["param3"] = DataBlock(data=self.param3, length=1, zero=0, addressing="32B")
    ...
    def setPIC(self):
        ...
        self.PIC[47:32] = self.w_in_addr + (self.k_h - 1) * self.k_w * self.c_in * self.c_out * self.w_dw / 256 + (self.k_w - 1) * self.c_in * self.c_out * self.w_dw / 256
        ...
        self.PIC[104:92] = self.x_in_w + (self.x_in_w - 1) * (self.xwjump - 1) + self.padding_left
        # self.PIC[116:104] = self.x_in_h + self.padding_top
        self.PIC[116:104] = self.x_in_h + (self.x_in_h - 1) * (self.xhjump - 1) + self.padding_top
        ...
        self.PIC[198:182] = self.param_addr_3
        ...
        self.PIC[230:226] = self.dilation_w
        self.PIC[234:230] = self.dilation_h
        self.PIC[245:234] = self.xwjump
        self.PIC[256:245] = self.xhjump
        
    def setAddrBlocks(self):
        pass

    def dilate_input(self, x_data_in: torch.tensor, dilation_h: int, dilation_w: int):
        """
    ...
    def rotate_180(self, w_data_in: torch.tensor):
        """
        将卷积核张量旋转180度
    ...
    def execute(self, core: EmuCore):
        ...
        # handle the input x tensor
        x_in_compute = self.dilate_input(x_tensor, self.xhjump, self.xwjump)
        padded_x_in = F.pad(x_in_compute,(self.padding_left,self.padding_right,self.padding_top,self.padding_bottom),value=self.padding_value)
        # handle the weight w tensor
        w_in_compute = self.rotate_180(w_tensor)
        ...
        y_tensor = self.handwritten_bf16_conv(padded_x_in, w_in_compute, b_tensor, y_tensor, self.stride_h, self.stride_w, self.dilation_h, self.dilation_w)
